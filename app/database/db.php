...
function getPublishedPosts(){
    global $conn;
    $sql = "SELECT p.*, u.fullname FROM posts AS p JOIN users AS u ON p.user_id=u.id WHERE p.published=?";
...
function getPostsByCategoryId($category_id){
    global $conn;
    $sql = "SELECT p.*, u.fullname FROM posts AS p JOIN users AS u ON p.user_id=u.id WHERE p.published=? AND category_id=?";
